...
function addSpecForm() {
  let specTemp = document.querySelector('#additional_detail');
  let insertPnt = document.querySelector('#additional_details');
...
//    */
//    (() => {
//        document.getElementById('image').onchange = initUpload;
//    })();
